...
class Client
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Vehicule::class, mappedBy="client", orphanRemoval=true)
     */
    private $vehicules;
    ...
    public function getHbdDay(): ?\DateTimeInterface
    {
        return $this->hbd_day;
    }

    public function setHbdDay(\DateTimeInterface $hbd_day): self
    {
        $this->hbd_day = $hbd_day;
